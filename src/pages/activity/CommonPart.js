              ...
              if (item.type)
                return (
                  <div>
                    ...
                    {item.type == 2 && <AdsPart item={item} index={index} type={type} />}
                    {item.type == 3 && (
                      <CouponList
                        item={item}
                        index={index}
                    ...
                    {item.type == 5 && (
                      <ActList item={item} index={index} onDelete={onDelete} type={type} />
                    )}
                  </div>
                );
            })}
        ...
        return (
          <div>
            ...
            <Row style={{ marginBottom: 20 }}>
              <Col push={1}>
                {data.bgImg ? (
                  <ImgBox src={data.bgImgUrl} imgType="bgImg" showLinkBox={false} />
                ) : null}
  ...
  return (
    <Row>
      <Collapse expandIconPosition="right">
        ...
        >
          <AddGoods
            dataSource={data.adviceGoods.goodsList}
            onChangeTableValue={onChangeTableValue}
            onDelete={onDelete}
          />
        </Collapse.Panel>
          ...
          <Collapse expandIconPosition="right">
            ...
            >
              ...
              <Row style={{ marginTop: 10 }}>
                ...
                <Button type="primary" onClick={onShow.bind(this, 'coupon', index)}>
                  添加优惠券
                </Button>
              </Row>
          ...
          <Collapse expandIconPosition="right">
            ...
            >
              ...
              <Row style={{ marginTop: 10 }}>
                ...
                <Button type="primary" onClick={onShow.bind(this, 'act', index)}>
                  绑定特卖专场
                </Button>
              </Row>
              <Row style={{ marginTop: 20 }}>
                  ...
                  {item.actPageList.map((item, tagIndex) => (
                    <div className={styles.nameBox} key={item.id}>
                      ...
                      <span
                        ...
                        onClick={onDeleteTag.bind(this, 'act', index, tagIndex)}
                      >
                        <Icon type="close-circle" theme="filled" />
                      </span>
                    </div>
      ...
      <Collapse expandIconPosition="right">
        ...
        >
          ...
          <Row style={{ marginTop: 10 }}>
            ...
            {item.adList &&
              item.adList.length > 0 &&
              item.adList.map((img, imgIndex) => (
                <ImgBox
                  src={img.adUrl}
                  imgType="adList"
                  index={index}
            ...
            <UploadBox imgType="adList" count={100} index={index} showUploadList={true} />
          </Row>
        </Collapse.Panel>
      </Collapse>
    </Row>
            ...
            >
              <Row>
                <Col span={10}>
                  ...
                  {data.rightNav.ad && data.rightNav.ad['img'] ? (
                    <ImgBox
                  ...
                  {data.rightNav.ad && data.rightNav['ad']['img'] ? null : (
                    <UploadBox imgType="navImg" count={1} />
                  )}
                </Col>
                <Col span={14}>
        ...
        <div className={styles.imgWrap}>
          ...
          {showLinkBox && (
            <Form.Item style={{ marginBottom: 0 }}>
              ...
              })(<Input placeholder="跳转链接，非必填" style={{ width: 200 }} />)}
            </Form.Item>
          )}
        </div>
      )}
          ...
          <Row>
            ...
            <Col span={8}>
              <Form.Item label="副标题" {...layout}>
                ...
                })(<Input placeholder="请输入副标题，20个汉字" style={{ width: 400 }} />)}
              </Form.Item>
            </Col>
            <Col span={8}>
              <Form.Item label="背景色" {...layout}>
                {getFieldDecorator(bgColor, {
                  ...
                  >
                    <Input onBlur={onChangeColor.bind(this, index, type)} />
                  </AutoComplete>,
                )}
              </Form.Item>
            </Col>
  ...
  const extraColumns = [
    {
      ...
      render: (sortOrder, record, recordIndex) => {
        return (
          <Input onChange={onChangeTableValue.bind(this, index, recordIndex)} value={sortOrder} />
        );
      },
    },
    {
      ...
      render: (_, record, recordIndex) => {
        return (
          <span
            ...
            onClick={onDelete.bind(this, index, record.goodsId)}
          >
            删除
          </span>
        );
      ...
      {({ onShow, uploadFile }) => (
        <div>
          <Row>
            ...
            <Col span={2}>
              <Button type="primary" onClick={onShow.bind(this, 'goods', index)}>
                添加商品
              </Button>
            </Col>
          </Row>
...
function UploadBox({ imgType, count, index = null, showUploadList = false }) {
  return (
    <MyContext.Consumer>
          ...
          {showAddOrMinus ? (
            data.plus ? (
              <Button
                ...
                shape="circle"
                icon="plus"
                onClick={addItem.bind(this, type, index, resetFields)}
              ></Button>
            ) : (
              <Button
                style={{ marginLeft: 10 }}
